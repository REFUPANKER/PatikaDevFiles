<div class="w-100 d-flex flex-column align-items-center ">
    ...
    <div <?php echo "id=\"video$key[0]\"" ?> class="w-75 m-2 p-3" style="background-color:#202020;border-radius:0.5vmax;">
        <div class="w-100 d-flex flex-row justify-content-center align-items-center" style="height:50vh;border: 1px solid white;padding:0.5rem">
            <?php require_once(GenerateVideoPath($key[0],".")) ?>
        </div>
        <h3 class='mt-2'><?= htmlspecialchars($key[1]) ?> </h3>
