<div class="w-100 d-flex flex-column align-items-center ">
    ...
    <div <?php echo "id=\"image$key[0]\"" ?> class="w-75 m-2 p-3" style="background-color:#202020;border-radius:0.5vmax;">
        <div class="w-100 d-flex flex-row justify-content-center align-items-center">
            <div class="rounded rounded-3" id="preview" style="border: 1px solid white; padding: 1rem;background-position: center; background-repeat: no-repeat;background-size: contain;aspect-ratio: 1;height:40vh;background-image:url('<?= $key[1] ?>')"></div>
        </div>
        <?php
            echo "<p class='mt-2' style='width:min-content;word-break:pre-line;white-space:pre;'>" . htmlspecialchars($key[2]) . "</p>";
        ?>
        <?php
